...
Linked_List(){
    ...
    // method to add element in the starrting of the linked list
...
secondLast.next=null; // you will delete the add stored in the second last which will break the link with the last node 
